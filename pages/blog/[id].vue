<template>
    <div class="">
        <div class="bg-[#002820] pt-80 w-full h-[450px]">

        </div>
        <div v-if="loading == true" class=" flex justify-center items-center relative bottom-36">
        ...
        <div v-else class="mt-[-200px] grid grid-cols-8 grid-rows-8 gap-x-9 gap-y-3 h-screen relative bottom-28">
            <main v-if="blog != null" class=" col-start-2 shadow-1 col-span-4 row-span-8 bg-white rounded-3xl">
                ...
                <div class=" mt-16 px-7 rtl text-right">
                    ...
                    <p v-html="blog.body" class=" text-gray-500 font-medium text-base mr-2"></p>
                </div>
