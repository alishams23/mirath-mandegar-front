    ...
    <div class="">
        ...
        <div class="mt-[-200px] grid grid-cols-8 grid-rows-8 gap-x-9 gap-y-3 ">
            <main class=" col-start-2 shadow-1 col-span-4 row-span-8 bg-white rounded-3xl">
                <div v-if="loading"
                    class='flex space-x-1 justify-center items-center bg-white w-[738.4px] h-[532px] rounded-3xl'>
            ...
            <aside class=" col-start-6 shadow-2 col-span-2 row-start-1 row-span-6 rounded-3xl bg-white">
                <div v-if="loading"
                    class='flex space-x-1 justify-center items-center bg-white w-[351.2px] h-[396px] rounded-3xl'>
                    <span class='sr-only'>Loading...</span>
                    <div class='h-5 w-5 bg-[#8b4513] rounded-full animate-bounce [animation-delay:-0.3s]'></div>
                    <div class='h-5 w-5 bg-[#8b4513] rounded-full animate-bounce [animation-delay:-0.15s]'></div>
                    <div class='h-5 w-5 bg-[#8b4513] rounded-full animate-bounce'></div>
