              ...
              <DialogPanel
                ...
                <div class="space-y-10 py-10 divide-y px-10 divide-gray-200">
                  ...
                  <div class="flex items-center pt-10">
                    <input v-model="is_discount" @click="is_discount = !is_discount; getData()" id="checked-checkbox"
                      type="checkbox" value="" class="w-4 h-4 text-black bg-gray-100 border-gray-300 rounded ">
                  ...
                  <div class=" ltr mb-6x">
                    ...
                    <div class="flex justify-between">
                      <span class="text-xs text-gray-500 mb-10 mt-14">ارزانترین ({{ formatPrice(price_range[0]) }}
                        تومان)</span>
                      <span class="text-xs text-gray-500 mb-10 mt-14">گرانترین ({{ formatPrice(price_range[1]) }}
                        تومان)</span>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    getCategories() {
      this.loading = true
      axios.get(`${apiStore().address}/api/product/ListCategories/?search=${this.text_search_categories}&is_main_page=${this.text_search_categories == null ? true : ''}`, {
        headers: {
          "Content-type": "application/json",
          Accept: "application/json",
        },
