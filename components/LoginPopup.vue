                ...
                <DialogPanel
                        ...
                        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <div class="space-y-6">
                                <div class="ltr">
                                    ...
                                    <div class="relative mt-2 rounded-full shadow-sm">
                                        <input type="text" name="phone-number" id="phone-number" v-model="phoneNumber"
                                ...
                                <div>
                                    <div
                                        class="flex w-full justify-center rounded-full bg-green-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                            ...
                            <div class="mt-10 pb-6 flex rtl flex-items-center">
                                ...
                                <p @click="dialog_page = 'register'"
                                    class="font-semibold text-sm text-center cursor-pointer leading-6 ps-2 text-green-800 hover:text-green-500">
                                    ثبت نام کنید</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <form class="space-y-6" >
                                ...
                                <div>
                                    ...
                                    <div v-if="isCooldownActive" class="text-green-500 flex  justify-center pt-5">
                                        {{ Math.floor(cooldownTime / 60) }}:{{ ('0' + cooldownTime %
                        60).slice(-2) }} تا ارسال مجدد
                                    </div>
                                    <div v-else class="text-green-800 flex cursor-pointer justify-center pt-5">
                            ...
                            <div class="mt-10 pb-6 flex ">
                                <p @click="dialog_page = 'get_number'"
                                    class="font-semibold text-center leading-6 cursor-pointer ps-2 text-green-800 hover:text-green-500">
                                    برگشت</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="dialog_page == 'register'"
                        ...
                        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <form class="space-y-6">
                                ...
                                <div class="sm:col-span-3">
                                    <label for="last-name" class="block text-sm font-medium leading-6 text-gray-900">نام
                                        خانوادگی</label>
                                    <div class="mt-2">
                                ...
                                <div>
                                    <!-- <div @click="sendSingUpSms" class="flex w-full justify-center rounded-full bg-green-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">دریافت کد</div> -->
                                    <div
                                        class="flex w-full justify-center rounded-full bg-green-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">

                                        <button @click="sendSingUpSms" class="w-full" v-if="loading == false">
                                            دریافت کد
                                        </button>
                            ...
                            <div class="mt-10 pb-6 flex  flex-items-center">
                                ...
                                <p @click="dialog_page = 'get_number'"
                                    class="font-semibold leading-6 ps-2  cursor-pointer text-green-800 hover:text-green-500">
                                    وارد شوید</p>
                            </div>
                        </div>
                    </div>
                    <div v-if="dialog_page == 'get_code_signup'"
                        ...
                        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <form class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div
                                        class="flex w-full justify-center rounded-full bg-green-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                                        <button @click="check_code_signup" class="w-full" v-if="loading == false">
                                            تایید
                                        </button>
                                        <div v-if="loading">
                                            <svg aria-hidden="true" role="status"
                        ...
                        60).slice(-2) }} تا ارسال مجدد
                            ...
                            <div class="mt-10 pb-6 flex ">
                                <p @click="dialog_page = 'register'"
                                    class="font-semibold cursor-pointer text-center leading-6 ps-2 text-green-800 hover:text-green-500">
                                    برگشت</p>
                            </div>
                        </div>
                    </div>
